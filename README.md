...
| -                                     |  -                                                                    |  -                                   |
| ------------------------------------  | ------------------------------------                                  | ------------------------------------|
| ✓ [LIVE Demo](https://django-material-kit.appseed-srv1.com/)  | 🚀 [LIVE Demo](https://django-material-kit2-enh.appseed-srv1.com) | 🛒 `Order`: **[$4,999](https://appseed.gumroad.com/l/rocket-package)** (GUMROAD) |  
